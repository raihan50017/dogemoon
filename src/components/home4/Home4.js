      ...
      <div style={{ backgroundColor: "#F7ECFF" }} class="x1 screen">
        ...
        <div className="page-container p-4">
            ...
            <div className="col-6">
              <div>
                <div className="d-flex justify-content-between no-wrap">
                  <div>
                    <h2 style={{ color: "#050517" }}>Community Driven</h2>
                  </div>
                  <div
              ...
              <div className="pt-4">
                <div className="d-flex justify-content-between no-wrap">
                  <div>
                    <h2 style={{ color: "#050517" }}>Automatic LP</h2>
                  </div>
              ...
              <div className="pt-4">
                <div className="d-flex justify-content-between no-wrap">
                  <div>
                    <h2 style={{ color: "#050517" }}>RFI Static Rewards</h2>
                  </div>
                  <div className="arrow-container">
                    <img
                      alt="right-arrow-img"
            ...
            <div className="row p-3">
              <div className="col-3 p-2">
                ...
                >
                  ...
                  ></img>
                  <h2 style={{ color: "#050517" }}>Mark</h2>
                  <p style={{ color: "#9871B8" }}>Tech & Advisor</p>
                  <div
                    style={{ width: "60%" }}
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(103.39deg, #FAF5FF 3.1%, #EFDCFF 104.43%",
            }}
          >
            <h1 style={{ color: "#050517" }} className="text-center p-5">
              Roadmap
            </h1>
            <div className="d-flex no-wrap justify-content-center align-items-center">
              ...
              <div style={{ width: "20%" }}>
                <p
                  ...
                  style={{ fontSize: "1.1vw", color: "#050517" }}
                >
